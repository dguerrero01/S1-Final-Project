            ...
            VStack {
                ...
                Spacer()
                    ...
                    .alert(isPresented: $gameOver, content: {
                        Alert(title: Text(winMessage), dismissButton: .destructive(Text("0 - 0"), action: {
                            withAnimation(Animation.default) {
                ...
                HStack {
                    ...
                    .padding()
                NavigationLink("Next Level", destination: Level_04().navigationBarHidden(true))
                    .padding()
                }
            }
        }
